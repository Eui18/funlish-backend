...
public class StudentGameRoutes {
    ...
    public void register(Javalin app) {
        ...
        app.get("/student-games/{activityStudentId}/content", controller::getContent);

        // Responder trivia
        app.post("/student-games/{activityStudentId}/trivia", controller::answerTrivia);

        // Responder scramble
        app.post("/student-games/{activityStudentId}/scramble", controller::answerScramble);
